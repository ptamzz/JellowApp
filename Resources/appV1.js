...
var audio;
var mainBtn = [], btn = [];
var detectedWidth, detectedHeight;
var inside = false;
...
Ti.API.info('Width: ' + detectedWidth + ", Height: " + detectedHeight);
...
Ti.Gesture.addEventListener('orientationchange', function(e) {
	...
	//Regenerate UI to accommodate new screen width-height
	clearUI();
	generateUI(true);
});
*/
...
var scrollView = Ti.UI.createScrollView({ 
	width: detectedWidth,
	contentWidth: detectedWidth, // 110, 
	contentHeight: 'auto',
	top: 0,
	left: 0,
...
var scrollViewWidth = detectedWidth-220;
...
function createButtons(data){
	...
	Ti.API.info("Create Buttons called.");
	...
	Ti.API.info("Inside CreateButtons(): detectedWidth = " + detectedWidth);
	...
	for (var i = 0; i < data.length; i++){
		...
		var someValue = 110+20+((detectedWidth-220-tempWidth-20)/2);

		Ti.API.info("Calculated: " + someValue);
