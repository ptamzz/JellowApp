...
static NSString * const kJellowJavascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_jellowInjection
{
	...
	[html appendString:kJellowJavascript];
...
{
	// attempt to make well-formed HTML and inject in our Jellow bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _jellowInjection]];
